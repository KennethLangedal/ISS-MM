...
void FMA(const float *a, const float *b, float *c, int n, int it)
{
    for (int t = 0; t < it; t++)
    {
        ...
        for (int i = 0; i < n; i += 64)
        {
            ...
            v8sf vc5 = _mm256_load_ps(c + i + 32);
            v8sf vc6 = _mm256_load_ps(c + i + 40);
            v8sf vc7 = _mm256_load_ps(c + i + 48);
            v8sf vc8 = _mm256_load_ps(c + i + 56);
            ...
            _mm256_store_ps(c + i + 32, vc5);
            _mm256_store_ps(c + i + 40, vc6);
            _mm256_store_ps(c + i + 48, vc7);
            _mm256_store_ps(c + i + 56, vc8);
        }
    }
}