...
\begin{frame}{Lists}
    ...
    Items in numbered lists like \enumref{enum:item} can be referenced with a
    red box.
...
\begin{frame}{Effects}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.49\textwidth}
            ...
            It creates a box
            with the specified width (here in a percentage of the slide's
            width)
